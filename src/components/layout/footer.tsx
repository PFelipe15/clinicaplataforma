        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start">
          <div className="flex flex-col items-center lg:items-start mb-8 lg:mb-0">
            <div className="flex items-center mb-4">
              <Image src={Logo} alt="Logo" width={100} height={100} className="rounded-full shadow-lg" />
              <h1 className="text-3xl font-extrabold ml-4">Urovida</h1>
            </div>
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="flex items-center mb-2">
              ...
              <a href="https://wa.me/55869993372499" target="_blank" rel="noopener noreferrer" className="ml-2 text-lg hover:text-gray-300 transition-all">(86) 9993372499</a>
            </div>
            <div className="flex items-center mb-2">
